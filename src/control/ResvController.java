...
public class ResvController {
	...
	public ResvView getResvView() { return resvView; }
	public RoomView getRoomView() { return roomView; }
	public MessageView getMessageView() { return messageView; }
	
	public void setResvView(ResvView v) {resvView = v;}
	public void setRoomView(RoomView v) {roomView = v;}
	public void setMessageView(MessageView v) {messageView = v;}
	...
	private boolean overlapped(
		...
		if (ckin1 > ckin2) {
			int t;
			t = ckin2;  ckin2  = ckin1;  ckin1 = t;
			t = ckout2; ckout2 = ckout1; ckout1 = t;
		}
		return (ckin2 < ckout1);
	}
	...
	public void add(Reservation r) {
		Reservation r2;
		if (!valid(r)) {
			messageView.append(r+" is invalid"); return;
		}
		if ((r2 = model.checkDuplicate(r.owner, r.ckin, r.ckout))!=null) {
			messageView.append(r+" is duplicated with "+r2); return;
		}
		model.add(r);
	}
